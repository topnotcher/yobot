...
#define KEYPAD_COLMASK ( KEYPAD_PIN(KEYPAD_PIN_C1) | KEYPAD_PIN(KEYPAD_PIN_C2) | KEYPAD_PIN(KEYPAD_PIN_C3) | KEYPAD_PIN(KEYPAD_PIN_C4) )
...
#define KEY_F1       KEY_PINS(1,4)
#define KEY_F2  	 KEY_PINS(2,4)
#define KEY_F3  	 KEY_PINS(3,4)
#define KEY_F4   	 KEY_PINS(4,4)
